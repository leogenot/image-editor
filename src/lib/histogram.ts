...
export async function computeHistogramFromBitmap(bitmap: ImageBitmap): Promise<HistogramData> {
...
export function computeHistogramFromRaw(pixels: Float32Array): HistogramData {
